...
3. Faça um clone desse repositório rodando: <br> `git clone https://github.com/diegodario88/e-commerce.git`;
4. Entre na pasta rodando pelo terminal: `cd e-commerce`;
